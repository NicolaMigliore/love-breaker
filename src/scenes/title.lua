...
function Title:enter(prev)
    ...
    local b_start = Luis.createElement('main', 'Button', 'START PLAYING', 8, 2, function() GameState.switch(GAME_SCENES.game) end, nil, 1,1)
    local b_test = Luis.createElement('main', 'Button', 'TEST', 8, 2, function() print 'pressed' end, nil, 1,1)
