...
function Particles:addPuff(x, y, r)
	...
	if r then ps:setDirection(r) end
...
function Particles:addBigPuff(x, y, r, colors)
	colors = colors or { 0.26953125, 0.22215270996094, 0.22215270996094, 1, 0.331298828125, 0.33332443237305, 0.4609375, 1, 0.72265625, 0.72265625, 0.72265625, 0.3984375 }
