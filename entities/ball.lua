...
function Ball:paddleCollision(paddle)
    local paddleCollision, collRectLeft, collRectRight, collRectTop, collRectBottom = Utils.collisionCircRect(self.pos.x, self.pos.y, self.rad, paddle.pos.x, paddle.pos.y, paddle.w, paddle.h)
...
function Ball:brickCollision(bricks)
    for i,brick in ipairs(bricks) do
        local brickCollision, collRectLeft, collRectRight, collRectTop, collRectBottom  = Utils.collisionCircRect(self.pos.x, self.pos.y, self.rad, brick.pos.x, brick.pos.y, brick.w, brick.h)
